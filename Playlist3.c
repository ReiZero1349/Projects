...
Assuming that shuffle functions are  not applicable,
choose an appropriate data structure that will add and delete songs onto you’re your iPod
in such a way that the recently inserted song will always be the first song currently on the iPod. */
